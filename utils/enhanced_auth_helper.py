...
"""
Enhanced Fyers Authentication Helper for MFS Trading Strategy
...
class FyersAuthManager:
        ...
        for attempt in range(max_attempts):
            ...
            try:
                ...
                if self.save_to_env('FYERS_PIN', pin):
                    ...
                    print(" PIN validation successful but couldn't save to .env file")
                    return pin
    ...
    def update_pin_simple(self) -> bool:
        ...
        print("=" * 50)
        print(" PIN will be visible on screen in this mode")
...
def setup_auth_only():
    ...
    print("=" * 80)
    print(" ENHANCED FYERS API AUTHENTICATION SETUP - MFS STRATEGY")
    print("=" * 80)
...
def test_authentication():
    ...
    try:
        print("\n" + "=" * 60)
        print(" FYERS AUTHENTICATION TEST - MFS STRATEGY")
        print("=" * 60)
...
def update_pin_only():
    ...
    try:
        print("\n" + "=" * 60)
        print(" UPDATE FYERS TRADING PIN - MFS STRATEGY")
        print("=" * 60)
...
def show_authentication_status():
    ...
    print("\n" + "=" * 60)
    print(" FYERS API AUTHENTICATION STATUS - MFS STRATEGY")
    print("=" * 60)
    ...
    print(f"  Run MFS Strategy: python main.py run")

    # Recommendations
    print(f"\n Recommendations:")
    if not access_token:
        print(f"   No access token found. Run setup: python main.py auth")
    elif not refresh_token:
        print(f"   No refresh token. Consider re-running setup for auto-refresh")
    elif not pin:
        print(f"   No trading PIN. Set PIN for automatic token refresh")
    else:
        print(f"   Authentication setup appears complete!")
        print(f"   Ready to run MFS strategy: python main.py run")


# Quick test function
if __name__ == "__main__":
    print("Enhanced Fyers Authentication Helper - MFS Strategy")
    print("=" * 60)
